...
<div class="checkout-popup checkout-popup--login" id="checkout-login-popup">
    ...
    <div class="checkout-popup__content">
        ...
        <div class="woocommerce-form-login" id="checkout-login-form" style="display:none;">
            <h3><?php esc_html_e( 'Zaloguj się', 'woocommerce' ); ?></h3>
            <?php
