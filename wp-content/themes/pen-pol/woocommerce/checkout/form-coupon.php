...
<div class="checkout-popup checkout-popup--coupon" id="checkout-coupon-popup">
    ...
    <div class="checkout-popup__content">
		...
		<form class="checkout_coupon woocommerce-form-coupon" method="post" id="checkout-coupon-form" style="display:none;">
			<h3><?php esc_html_e( 'Dodaj kod rabatowy', 'woocommerce' ); ?></h3>
			<p><?php esc_html_e( 'Jeśli posiadasz kod rabatowy, wprowadź go poniżej.', 'woocommerce' ); ?></p>
