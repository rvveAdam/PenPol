...
if ($date_diff <= 7) {
    ...
    if ($regular_price > 0) {
        ...
        // Best price (discount > 50%)
        if ($percentage > 50) {
            $badge_type = 'best-price';
            $badge_text = __('Najlepsza Cena', 'pen-pol');
        } 
        // Promotion 50% (discount between 49% and 51%)
        elseif ($percentage >= 49 && $percentage <= 51) {
...
<div class="product-card">
    <div class="product-card__wrapper">
        <?php if (!empty($badge_type) && !empty($badge_text)) : ?>
            <div class="product-card__tag product-card__tag--<?php echo esc_attr($badge_type); ?>">
